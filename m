...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id C9918760364
	for <lists+sparclinux@lfdr.de>; Tue, 25 Jul 2023 01:59:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229628AbjGXX7D (ORCPT <rfc822;lists+sparclinux@lfdr.de>);
        Mon, 24 Jul 2023 19:59:03 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:50146 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229452AbjGXX7D (ORCPT
        <rfc822;sparclinux@vger.kernel.org>); Mon, 24 Jul 2023 19:59:03 -0400
Received: from mx.treblig.org (unknown [IPv6:2a00:1098:5b::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id CC5AA171E;
        Mon, 24 Jul 2023 16:58:59 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=treblig.org
        ...
        bh=QUd3EVdFtTMFXEqU+5o+IGVeiyyk5seLJvbaIU+1giA=; b=sKdnilLXMQ36qIqHtwL6jzTHmI
        ;
Received: from localhost ([127.0.0.1] helo=dalek.home.treblig.org)
        by mx.treblig.org with esmtp (Exim 4.94.2)
        (envelope-from <linux@treblig.org>)
        id 1qO5S2-0032G4-6m; Mon, 24 Jul 2023 23:58:53 +0000
From:   linux@treblig.org
To:     davem@davemloft.net, sam@ravnborg.org, benh@kernel.crashing.org
Cc:     sparclinux@vger.kernel.org, linux-kernel@vger.kernel.org,
        "Dr. David Alan Gilbert" <linux@treblig.org>
Subject: [PATCH v2] sparc: Use shared font data
Date:   Tue, 25 Jul 2023 00:58:51 +0100
Message-ID: <20230724235851.165871-1-linux@treblig.org>
...
---
 ...
 2 files changed, 10 insertions(+), 356 deletions(-)
