Return-Path: <sparclinux+bounces-7040-lists+sparclinux=lfdr.de@vger.kernel.org>
Delivered-To: lists+sparclinux@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id C7FlJT0bT2qlagIAu9opvQ
	(envelope-from <sparclinux+bounces-7040-lists+sparclinux=lfdr.de@vger.kernel.org>)
	for <lists+sparclinux@lfdr.de>; Thu, 09 Jul 2026 05:53:33 +0200
X-Original-To: lists+sparclinux@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [104.64.211.4])
	by mail.lfdr.de (Postfix) with ESMTPS id BEFA372C74E
	for <lists+sparclinux@lfdr.de>; Thu, 09 Jul 2026 05:53:32 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=huawei.com header.s=dkim header.b=r6RtRSgk;
	dmarc=pass (policy=quarantine) header.from=huawei.com;
	spf=pass (mail.lfdr.de: domain of "sparclinux+bounces-7040-lists+sparclinux=lfdr.de@vger.kernel.org" designates 104.64.211.4 as permitted sender) smtp.mailfrom="sparclinux+bounces-7040-lists+sparclinux=lfdr.de@vger.kernel.org";
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 2F794303D96F
	for <lists+sparclinux@lfdr.de>; Thu,  9 Jul 2026 03:46:21 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B0203391E7B;
...
X-Spamd-Result: default: False [-9.16 / 15.00];
	...
	TAGGED_FROM(0.00)[bounces-7040-lists,sparclinux=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
