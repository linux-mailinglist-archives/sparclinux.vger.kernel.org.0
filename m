Return-Path: <sparclinux+bounces-6436-lists+sparclinux=lfdr.de@vger.kernel.org>
Delivered-To: lists+sparclinux@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qDpyN+VNqGmvsgAAu9opvQ
	(envelope-from <sparclinux+bounces-6436-lists+sparclinux=lfdr.de@vger.kernel.org>)
	for <lists+sparclinux@lfdr.de>; Wed, 04 Mar 2026 16:21:09 +0100
X-Original-To: lists+sparclinux@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 4F810202847
	for <lists+sparclinux@lfdr.de>; Wed, 04 Mar 2026 16:21:09 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 321FF30A3152
	for <lists+sparclinux@lfdr.de>; Wed,  4 Mar 2026 15:06:42 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id B0B22343D7B;
...
X-Spamd-Result: default: False [-1.16 / 15.00];
	...
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-6436-lists,sparclinux=lfdr.de];
	MIME_TRACE(0.00)[0:+];
