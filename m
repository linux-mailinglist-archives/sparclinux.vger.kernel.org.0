...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 1D7CE75EC92
	for <lists+sparclinux@lfdr.de>; Mon, 24 Jul 2023 09:33:04 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230206AbjGXHdC (ORCPT <rfc822;lists+sparclinux@lfdr.de>);
        Mon, 24 Jul 2023 03:33:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:60172 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S231249AbjGXHc4 (ORCPT
        <rfc822;sparclinux@vger.kernel.org>); Mon, 24 Jul 2023 03:32:56 -0400
X-Greylist: delayed 964 seconds by postgrey-1.37 at lindbergh.monkeyblade.net; Mon, 24 Jul 2023 00:32:51 PDT
Received: from mailrelay4-1.pub.mailoutpod2-cph3.one.com (mailrelay4-1.pub.mailoutpod2-cph3.one.com [IPv6:2a02:2350:5:403::1])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C1372180
        for <sparclinux@vger.kernel.org>; Mon, 24 Jul 2023 00:32:51 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=ravnborg.org; s=rsa1;
        h=in-reply-to:content-type:mime-version:references:message-id:subject:cc:to:
         from:date:from;
        bh=FE5FPrImuqptQrWO7mrwtXSbdGRIo6u2inHk4LJ5zvI=;
        b=
DKIM-Signature: v=1; a=ed25519-sha256; c=relaxed/relaxed;
        d=ravnborg.org; s=ed1;
        h=in-reply-to:content-type:mime-version:references:message-id:subject:cc:to:
         from:date:from;
        bh=FE5FPrImuqptQrWO7mrwtXSbdGRIo6u2inHk4LJ5zvI=;
        b=rcnAlhnt9B4zh6Xx9cLh+rrA53mC8n5XQ2tL0aJg9UUgKrJAVxQ04shp5jI+491+7xc+MsZFV/tFC
         pXzmwsuAA==
X-HalOne-ID: 0a850259-29f2-11ee-8166-592bb1efe9dc
Received: from ravnborg.org (2-105-2-98-cable.dk.customer.tdc.net [2.105.2.98])
        by mailrelay4 (Halon) with ESMTPSA
        id 0a850259-29f2-11ee-8166-592bb1efe9dc;
        Mon, 24 Jul 2023 07:16:44 +0000 (UTC)
Date:   Mon, 24 Jul 2023 09:16:43 +0200
From:   Sam Ravnborg <sam@ravnborg.org>
To:     linux@treblig.org
Cc:     davem@davemloft.net, benh@kernel.crashing.org,
        sparclinux@vger.kernel.org, linux-kernel@vger.kernel.org
Subject: Re: [PATCH] sparc: Use shared font data
Message-ID: <20230724071643.GA644337@ravnborg.org>
References: <20230724005929.175318-1-linux@treblig.org>
MIME-Version: 1.0
Content-Type: text/plain; charset=us-ascii
Content-Disposition: inline
In-Reply-To: <20230724005929.175318-1-linux@treblig.org>
