Return-Path: <sparclinux+bounces-6658-lists+sparclinux=lfdr.de@vger.kernel.org>
Delivered-To: lists+sparclinux@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id 6MIeDgvs2GlGjwgAu9opvQ
	(envelope-from <sparclinux+bounces-6658-lists+sparclinux=lfdr.de@vger.kernel.org>)
	for <lists+sparclinux@lfdr.de>; Fri, 10 Apr 2026 14:24:43 +0200
X-Original-To: lists+sparclinux@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id D4C463D6EAD
	for <lists+sparclinux@lfdr.de>; Fri, 10 Apr 2026 14:24:42 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id 348BE305BFB1
	for <lists+sparclinux@lfdr.de>; Fri, 10 Apr 2026 12:20:55 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4BA883C5DCE;
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-6658-lists,sparclinux=lfdr.de];
	RCVD_TLS_LAST(0.00)[];
